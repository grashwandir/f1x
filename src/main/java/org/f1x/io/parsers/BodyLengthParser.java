...
public class BodyLengthParser {
    ...
    /**
     * BodyLength is always the second field in the message. Count the number of
     * characters in the message following the BodyLength field up to, and
     * including, the delimiter immediately preceding the CheckSum tag ("10=").
     */
    static int parseBodyLength(ByteRingReader reader) {
        ...
        } while ((b = reader.next()) != AsciiUtils.SOH);
